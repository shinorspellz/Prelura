...
class _$OrderModelImpl implements _OrderModel {
  ...
  @override
  String toString() {
    return 'OrderModel(id: $id, product: $product, quantity: $quantity, priceTotal: $priceTotal, shippingFee: $shippingFee, status: $status, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, product, quantity,
      priceTotal, shippingFee, status, createdAt, updatedAt);
