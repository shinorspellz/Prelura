...
class ProductListNotifier extends StateNotifier<SharedData> {
  ProductListNotifier()
...
final selectedProductListNotifierProvider =
    StateNotifierProvider<ProductListNotifier, SharedData>(
