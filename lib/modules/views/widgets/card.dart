            ...
            if (widget.isSimilar) ...[
              GestureDetector(
                onTap: () {
                  ...
                  context.router.push(ProfileDetailsRoute(username: user?.username == widget.product.seller.username ? null : widget.product.seller.username));
                },
                child: Row(
                  children: [
                    ...
                    Text(
                      ...
                      style: Theme.of(context).textTheme.bodySmall!.copyWith(fontWeight: FontWeight.w400, fontSize: 12, color: Theme.of(context).textTheme.bodyMedium?.color),
                    ),
                  ],
                ),
              ),
