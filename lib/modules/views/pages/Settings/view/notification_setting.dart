...
import 'package:prelura_app/modules/views/widgets/switch_with_text.dart';
...
class NotificationSettingScreen extends ConsumerStatefulWidget {
  NotificationSettingScreen({super.key, required this.title});
  final String title;
...
class _NotificationSettingScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final emailnotificationPreferences = widget.title == "Email"
