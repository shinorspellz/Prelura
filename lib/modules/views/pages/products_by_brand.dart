...
class _ProductsByBrandPageState extends ConsumerState<ProductsByBrandPage> {
  ...
  void initState() {
    ...
    controller.addListener(() {
      ...
      if (maxScroll - currentScroll <= delta) {
        ...
        ref.read(filterProductByBrandProvider((Input$ProductFiltersInput(brand: widget.id, customBrand: widget.customBrand), searchQuery)).notifier).fetchMoreData();
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    final productProvider = ref.watch(filterProductByBrandProvider((Input$ProductFiltersInput(brand: widget.id, customBrand: widget.customBrand), searchQuery)));
    final productNotifier = ref.read(filterProductByBrandProvider((Input$ProductFiltersInput(brand: widget.id, customBrand: widget.customBrand), searchQuery)).notifier);
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          await ref.refresh(filterProductByBrandProvider((Input$ProductFiltersInput(brand: widget.id, customBrand: widget.customBrand), searchQuery)).future);
          ...
          child: Padding(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                ...
                ref.watch(filterProductByBrandProvider((Input$ProductFiltersInput(brand: widget.id, customBrand: widget.customBrand), searchQuery))).maybeWhen(
                ...
                SliverPadding(
                  ...
                  sliver: ref.watch(filterProductByBrandProvider((Input$ProductFiltersInput(brand: widget.id, customBrand: widget.customBrand), searchQuery))).when(
                      data: (products) {
                              ...
                              children: [
                                ...
                                TextButton.icon(
                                  onPressed: () {
                                    ...
                                    ref.invalidate(filterProductByBrandProvider);
                                  },
                ...
                if (ref.watch(filterProductByBrandProvider((Input$ProductFiltersInput(brand: widget.id, customBrand: widget.customBrand), searchQuery)).notifier).canLoadMore())
                  if (!ref.watch(filterProductByBrandProvider((Input$ProductFiltersInput(brand: widget.id, customBrand: widget.customBrand), searchQuery))).isLoading)
