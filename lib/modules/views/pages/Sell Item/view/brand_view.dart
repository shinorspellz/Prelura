...
class BrandSelectionPage extends ConsumerWidget {
  ...
  final List<String> popularBrands = ['Dickies', 'Next', 'Primark', 'Shein', 'Zara', 'H&M', 'New Look', 'Marks & Spencer', 'George', 'E&F'];
              ...
              children: [
                      ...
                      children: [
                        ListTile(
                          ...
                          trailing: Radio<String>(
                            ...
                            onChanged: (value) => {ref.read(selectedBrandProvider.notifier).selectBrand(value), context.back()},
                          ),
                        ),
                        const Divider(
                          thickness: 1,
                ...
                ...popularBrands.map((brand) => Column(
                      children: [
                        ListTile(
                          title: Text(brand),
                          trailing: Radio<String>(value: brand, groupValue: selectedBrand, onChanged: (value) => {ref.read(sellItemProvider.notifier).selectBrand(value), context.back()}),
                        ),
                        const Divider(
                          thickness: 1,
                        ),
