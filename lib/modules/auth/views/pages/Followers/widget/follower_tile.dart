...
import 'package:prelura_app/modules/auth/views/pages/Following/provider/follower_provider.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          CircleAvatar(
            backgroundImage: follower.profilePicture.isNotEmpty
                ? NetworkImage(follower.profilePicture)
                : null,
            child: follower.profilePicture.isEmpty
          ...
          AppButton(
            ...
            onTap: () {
              if (isFollowerModel) {
                ref
                    .read(followersProvider.notifier)
