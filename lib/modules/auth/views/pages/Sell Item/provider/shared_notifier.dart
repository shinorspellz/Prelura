...
class SharedDataNotifier extends StateNotifier<List<SharedData>> {
  ...
  SharedDataNotifier(this.ref)
      : super([
          SharedData(
            selectedValue:
                ref.watch(selectedCategoryNotifierProvider).selectedValue,
            relatedStrings:
                ref.watch(selectedCategoryNotifierProvider).relatedStrings,
          ),
        ]);
...
// Riverpod provider
final sharedProductNotifierProvider =
    StateNotifierProvider<SharedDataNotifier, List<SharedData>>(
