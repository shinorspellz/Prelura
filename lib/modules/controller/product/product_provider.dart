...
final filterProductByBrandProvider = AsyncNotifierProvider.family<FilteredBrandProductController, List<ProductModel>, (Input$ProductFiltersInput, String)>(FilteredBrandProductController.new);

class FilteredBrandProductController extends FamilyAsyncNotifier<List<ProductModel>, (Input$ProductFiltersInput, String)> {
  late final _repository = ref.read(productRepo);
