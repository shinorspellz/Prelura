...
// class Women extends ConsumerWidget {
//   const Women({super.key, required this.searchQuery, required this.id, required this.title, required this.products});
