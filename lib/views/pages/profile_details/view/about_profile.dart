                                                ...
                                                content: Column(
                                                  ...
                                                  children: [
                                                    PreluraAuthTextField(
                                                      label: 'Bio',
                                                      labelStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(fontSize: getDefaultSize(), fontWeight: FontWeight.w400),
                                                      hintStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(fontSize: getDefaultSize(), fontWeight: FontWeight.w400),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        user?.location?.locationName ?? "Exeter, United Kingdom",
