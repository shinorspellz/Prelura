    ...
    return Scaffold(
        ...
        body: Container(
          ...
          PreluraSwitchWithText(
            ...
            textStyle: Theme.of(context).textTheme.bodySmall?.copyWith(fontWeight: FontWeight.w600, fontSize: 12.sp),
          ...
          Container(
              ...
              child: Text("Allow your customers to get exclusive discount when they buy multiple items from your shop.",
