...
class _NewPasswordScreenState extends ConsumerState<NewPasswordScreen> {
  ...
  void _resetPassword() async {
    ...
    if (newPasswordError == null && confirmPasswordError == null && otpError == null) {
      final newPassword = _newPasswordController.text;
      final otp = _otpController.text;

      await ref.read(forgotPasswordProvider.notifier).resetPassword(newPassword: newPassword, token: otp, email: widget.email.trim());
      ref.read(forgotPasswordProvider).whenOrNull(
            error: (e, _) => context.alert(e.toString()),
            data: (data) async {
              log(data.toString());
              HelperFunction.context = context;
              HelperFunction.showToast(message: '$data, login with your new pass word' ?? "");
