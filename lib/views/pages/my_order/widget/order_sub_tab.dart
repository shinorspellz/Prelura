...
class _OrderSubTabsState extends ConsumerState<OrderSubTabs> with SingleTickerProviderStateMixin {
                ...
                return Expanded(
                  child: GestureDetector(
                    onTap: () {
                      ...
                      ref.read(activeFilterProvider.notifier).state = filters[index];
                    },
  ...
  Widget _buildTab(int index) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelected ? PreluraColors.activeColor.withOpacity(0.2) : Colors.transparent,
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: isSelected ? PreluraColors.activeColor : PreluraColors.greyColor,
          width: 2,
        ),
      ),
      ...
      child: Center(
        child: Text(
          ...
          style: TextStyle(
            fontSize: 16,
            color: isSelected ? PreluraColors.activeColor : Theme.of(context).textTheme.bodyMedium?.color,
