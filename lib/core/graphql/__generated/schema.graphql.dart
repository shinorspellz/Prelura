...
import 'package:prelura_app/model/product/product_model.dart' as EnumImport$ConditionEnum;
...
class Input$NotificationsPreferenceInputType {
  ...
  factory Input$NotificationsPreferenceInputType.fromJson(Map<String, dynamic> data) {
    final result$data = <String, dynamic>{};
  ...
  CopyWith$Input$NotificationsPreferenceInputType<Input$NotificationsPreferenceInputType> get copyWith => CopyWith$Input$NotificationsPreferenceInputType(
        this,
        (i) => i,
      );
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Input$NotificationsPreferenceInputType || runtimeType != other.runtimeType) {
      return false;
    }
    final l$likes = likes;
    ...
    if (_$data.containsKey('newFollowers') != other._$data.containsKey('newFollowers')) {
      return false;
    }
    ...
    if (_$data.containsKey('profileView') != other._$data.containsKey('profileView')) {
      return false;
    }
    ...
    if (_$data.containsKey('messages') != other._$data.containsKey('messages')) {
      return false;
    }
...
abstract class CopyWith$Input$NotificationsPreferenceInputType<TRes> {
  ...
  factory CopyWith$Input$NotificationsPreferenceInputType.stub(TRes res) = _CopyWithStubImpl$Input$NotificationsPreferenceInputType;
...
class _CopyWithImpl$Input$NotificationsPreferenceInputType<TRes> implements CopyWith$Input$NotificationsPreferenceInputType<TRes> {
  _CopyWithImpl$Input$NotificationsPreferenceInputType(
    this._instance,
    this._then,
  );
...
class _CopyWithStubImpl$Input$NotificationsPreferenceInputType<TRes> implements CopyWith$Input$NotificationsPreferenceInputType<TRes> {
...
class Input$ProductFiltersInput {
  ...
  factory Input$ProductFiltersInput.fromJson(Map<String, dynamic> data) {
    ...
    if (data.containsKey('hashtags')) {
      ...
      result$data['hashtags'] = (l$hashtags as List<dynamic>?)?.map((e) => (e as String?)).toList();
    }
  ...
  bool operator ==(Object other) {
    ...
    if (_$data.containsKey('discountPrice') != other._$data.containsKey('discountPrice')) {
      return false;
    }
    ...
    if (_$data.containsKey('hashtags') != other._$data.containsKey('hashtags')) {
      return false;
    }
  ...
  TRes call({
    ...
    Object? hashtags = _undefined,
      ...
      _then(Input$ProductFiltersInput._({
        ...
        if (discountPrice != _undefined) 'discountPrice': (discountPrice as bool?),
...
class Input$ProfilePictureInputType {
  ...
  CopyWith$Input$ProfilePictureInputType<Input$ProfilePictureInputType> get copyWith => CopyWith$Input$ProfilePictureInputType(
        this,
        (i) => i,
      );
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Input$ProfilePictureInputType || runtimeType != other.runtimeType) {
      return false;
    }
    final l$profilePictureUrl = profilePictureUrl;
...
abstract class CopyWith$Input$ProfilePictureInputType<TRes> {
  ...
  factory CopyWith$Input$ProfilePictureInputType.stub(TRes res) = _CopyWithStubImpl$Input$ProfilePictureInputType;
...
class _CopyWithImpl$Input$ProfilePictureInputType<TRes> implements CopyWith$Input$ProfilePictureInputType<TRes> {
  _CopyWithImpl$Input$ProfilePictureInputType(
    this._instance,
    this._then,
  );
...
class _CopyWithStubImpl$Input$ProfilePictureInputType<TRes> implements CopyWith$Input$ProfilePictureInputType<TRes> {
...
enum Enum$ChatsMessageAttachmentTypeChoices {
  ...
  factory Enum$ChatsMessageAttachmentTypeChoices.fromJson(String value) => fromJson$Enum$ChatsMessageAttachmentTypeChoices(value);

  String toJson() => toJson$Enum$ChatsMessageAttachmentTypeChoices(this);
}

String toJson$Enum$ChatsMessageAttachmentTypeChoices(Enum$ChatsMessageAttachmentTypeChoices e) {
  switch (e) {
...
Enum$ChatsMessageAttachmentTypeChoices fromJson$Enum$ChatsMessageAttachmentTypeChoices(String value) {
  switch (value) {
    case r'PICTURE':
...
enum Enum$PaymentMethodEnum {
  ...
  factory Enum$PaymentMethodEnum.fromJson(String value) => fromJson$Enum$PaymentMethodEnum(value);
...
enum Enum$PaymentsPaymentPaymentMethodChoices {
  ...
  factory Enum$PaymentsPaymentPaymentMethodChoices.fromJson(String value) => fromJson$Enum$PaymentsPaymentPaymentMethodChoices(value);

  String toJson() => toJson$Enum$PaymentsPaymentPaymentMethodChoices(this);
}

String toJson$Enum$PaymentsPaymentPaymentMethodChoices(Enum$PaymentsPaymentPaymentMethodChoices e) {
  switch (e) {
...
Enum$PaymentsPaymentPaymentMethodChoices fromJson$Enum$PaymentsPaymentPaymentMethodChoices(String value) {
  switch (value) {
    case r'BANK_TRANSFER':
...
enum Enum$PaymentsPaymentPaymentStatusChoices {
  ...
  factory Enum$PaymentsPaymentPaymentStatusChoices.fromJson(String value) => fromJson$Enum$PaymentsPaymentPaymentStatusChoices(value);

  String toJson() => toJson$Enum$PaymentsPaymentPaymentStatusChoices(this);
}

String toJson$Enum$PaymentsPaymentPaymentStatusChoices(Enum$PaymentsPaymentPaymentStatusChoices e) {
  switch (e) {
...
Enum$PaymentsPaymentPaymentStatusChoices fromJson$Enum$PaymentsPaymentPaymentStatusChoices(String value) {
  switch (value) {
    case r'PENDING':
...
enum Enum$ProductGroupingEnum {
  ...
  factory Enum$ProductGroupingEnum.fromJson(String value) => fromJson$Enum$ProductGroupingEnum(value);
...
enum Enum$ProductsOrderStatusChoices {
  ...
  factory Enum$ProductsOrderStatusChoices.fromJson(String value) => fromJson$Enum$ProductsOrderStatusChoices(value);

  String toJson() => toJson$Enum$ProductsOrderStatusChoices(this);
}

String toJson$Enum$ProductsOrderStatusChoices(Enum$ProductsOrderStatusChoices e) {
  switch (e) {
...
Enum$ProductsOrderStatusChoices fromJson$Enum$ProductsOrderStatusChoices(String value) {
  switch (value) {
    case r'PENDING':
...
enum Enum$SeasonEnum {
  ...
  factory Enum$SeasonEnum.fromJson(String value) => fromJson$Enum$SeasonEnum(value);
