import 'package:prelura_app/core/utils/profanity/profanity_list.dart';
...
class ProfanityFilter {
  ...
  ProfanityFilter.filterOnly(List<String> badWordsList) {
    wordsToFilterOutList = badWordsList;
  }
  ...
  ProfanityFilter.ignore(List<String> ignoreList) {
    wordsToFilterOutList = defaultWordsToFilterOutList;
    for (var word in ignoreList) {
      wordsToFilterOutList.remove(word);
    }
  }
  ...
  ProfanityFilter.filterAdditionally(List<String> badWordsList) {
    wordsToFilterOutList = [...defaultWordsToFilterOutList, ...badWordsList];
  }
  ...
  bool hasProfanity(String inputString) {
    ...
    for (var word in wordsToFilterOutList) {
